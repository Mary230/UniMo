...
def binary_class(true_answer_file_name, user_answer_file_name):
    true_answer_cvs = pd.read_csv('/Users/bmacha/PycharmProjects/djangoProject/media/' + true_answer_file_name)
    user_answer_cvs = pd.read_csv('/Users/bmacha/PycharmProjects/djangoProject/media/' + user_answer_file_name)
